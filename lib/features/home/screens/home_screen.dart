...
import 'package:goku/features/admin/screens/create_staff_screen.dart';
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  IconButton(
                    icon:
                        const Icon(Icons.create, color: AppColors.kGreenColor),
                    onPressed: () {
                      Navigator.pushNamed(context, '/raise_issue');
                    },
                  ),
                ...
                CategoryCard(
                  ...
                  onTap: () {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text('Fees option is only for users'),
